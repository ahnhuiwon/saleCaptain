...
const get_item = async () => {
  ...
  $(".fm_best_widget ul li").map(async (index, element) => {
    arr_list[index] = {
      ...
      shop: String(
        $(element)
          .find("div:nth-of-type(1) > .hotdeal_info span:nth-child(1)")
          .text()
      ),
      price: String(
        $(element)
          .find("div:nth-of-type(1) > .hotdeal_info span:nth-child(2)")
          .text()
      ),
      img: String(
        $(element)
      ...
      lnk: String(
        $(element).find("div:nth-of-type(1) > a:nth-child(1)").attr("href")
      ),
    };
  });
}
